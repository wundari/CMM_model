...
class General:
    ...
    def load_vtc(self, sbj):
        ...
        for roi in range(self.n_ROIs):
            ...
            vtc_df = vtc_df.append(vtc_roi_df)
    ...
    def load_vtc_normalized_vox(self, sbjID, nVox_to_analyze):
        ...
        vtc_norm = pd.read_pickle(
            "../../../../Data/VTC_normalized/vtc_norm_{}_{}".format(
    ...
    def label_vtc_at_run(self, vtc, vtc_stimID, run):
        ...
        for t in range(1, self.n_blocks_per_run + 1):
            ...
            vtc_run.loc[
                vtc_run.timepoint.isin(range(t_start, t_end)), "stimID"
            ] = stimID
            ...
            if stimID == 1:
                vtc_run.loc[
                    vtc_run.timepoint.isin(range(t_start, t_end)), "rep"
                ] = count_cond1
