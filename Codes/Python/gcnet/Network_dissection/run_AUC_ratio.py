...
# %%
save_flag = 0
aucr.plotHist_auc_ratio(auc_ratio_all_layer, save_flag)
aucr.plotLine_auc_ratio(auc_ratio_all_layer, save_flag)
# aucr.plotLine_auc_ratio_all_dotDens(save_flag)
# aucr.plotLine_auc_as_func_dot_corr(auc_ratio_all_layer, save_flag)
aucr.plotScatter_neuron_pref_input_interocular_corr_vs_auc_ratio(save_flag)

# interocular pref inputs all units
aucr.PlotBox_neuron_pref_input_interocular_corr(save_flag)

# interocular pref inputs only for cross-correlation neurons
aucr.PlotBox_neuron_pref_input_interocular_corr_xcorr(save_flag)
